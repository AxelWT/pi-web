...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.tabLabel": "Terminal",
    "terminal.starting": "Starting terminal…",
    "terminal.notInstalled": "Terminal unavailable — the node-pty native module failed to install. On Linux, install build tools (e.g. `build-essential python3`) and reinstall.",
    "terminal.disabledByConfig": "Terminal is disabled (PI_WEB_TERMINAL=0).",
    ...
    "files.edit": "Edit",
    "files.save": "Save",
    "files.saveHint": "Save (Cmd/Ctrl+S)",
    "files.cancelEdit": "Cancel edit",
    "files.saveFailed": "Save failed: {error}",
    "files.unsavedChanges": "Discard unsaved changes?",
    "files.externalModified": "This file was modified outside the editor. Reload to load the latest version.",
    "files.reload": "Reload",
    "files.reloadOverwriteConfirm": "Overwrite your unsaved edits with the version on disk?",
    "files.newFile": "New file",
    "files.newFolder": "New folder",
    "files.delete": "Delete",
    "files.promptFileName": "File name",
    "files.promptFolderName": "Folder name",
    "files.confirmDeleteFile": "Delete \"{name}\"? This cannot be undone.",
    "files.confirmDeleteDirectory": "Delete \"{name}\" and all its contents? This cannot be undone.",
    "files.revert": "Revert",
    "files.restore": "Restore",
    "files.confirmRevertChanges": "Revert all changes in \"{name}\"? This cannot be undone.",
    "files.confirmRestoreDeleted": "Restore deleted file \"{name}\"?",
    "files.revertFailed": "Revert failed: {error}",
    "files.revertAll": "Revert all",
    "files.confirmRevertAll": "Revert all {count} changed files? This cannot be undone.",
    "files.revertAllPartial": "{reverted} reverted, {skipped} skipped (need manual handling).",
