...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.tabLabel": "终端",
    "terminal.starting": "正在启动终端…",
    "terminal.notInstalled": "终端不可用 — node-pty 原生模块安装失败。Linux 用户请安装编译工具（如 `build-essential python3`）后重新安装。",
    "terminal.disabledByConfig": "终端已禁用（PI_WEB_TERMINAL=0）。",
    "terminal.error": "终端错误",
    ...
    "files.edit": "编辑",
    "files.save": "保存",
    "files.saveHint": "保存（Cmd/Ctrl+S）",
    "files.cancelEdit": "取消编辑",
    "files.saveFailed": "保存失败：{error}",
    "files.unsavedChanges": "放弃未保存的改动？",
    "files.externalModified": "文件已被外部修改。重新加载以获取最新版本。",
    "files.reload": "重新加载",
    "files.reloadOverwriteConfirm": "用磁盘上的版本覆盖未保存的改动？",
    "files.newFile": "新建文件",
    "files.newFolder": "新建文件夹",
    "files.delete": "删除",
    "files.promptFileName": "文件名",
    "files.promptFolderName": "文件夹名",
    "files.confirmDeleteFile": "删除“{name}”？此操作无法撤销。",
    "files.confirmDeleteDirectory": "删除“{name}”及其所有内容？此操作无法撤销。",
    "files.revert": "回滚",
    "files.restore": "恢复",
    "files.confirmRevertChanges": "回滚“{name}”的所有改动？此操作不可撤销。",
    "files.confirmRestoreDeleted": "恢复已删除的文件“{name}”？",
    "files.revertFailed": "回滚失败：{error}",
    "files.revertAll": "全部回滚",
    "files.confirmRevertAll": "回滚全部 {count} 个改动文件？此操作不可撤销。",
    "files.revertAllPartial": "{reverted} 个已回滚，{skipped} 个跳过（需手动处理）。",
